...
export function RulesLink({ playerId }: RulesLinkProps) {
	...
	return (
		<details className="relative z-50" data-testid="rules-menu">
			<summary className="min-h-11 cursor-pointer list-none rounded border bg-surface px-3 py-2 text-sm">
				Rules
			</summary>
			<div className="absolute top-12 right-0 w-[min(24rem,calc(100vw-2rem))] space-y-2 rounded border bg-surface p-3 shadow-xl">
